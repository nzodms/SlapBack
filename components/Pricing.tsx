...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      { label: "Runs in browser tab only", included: true },
      { label: "Foreground only", included: true },
      { label: "Limited sounds & triggers", included: true },
      { label: "Native Mac app", included: false },
      { label: "System-wide triggers", included: false },
      { label: "Menu bar + global overlay", included: false },
      { label: "All sounds & triggers", included: false },
    ],
    cta: "Try web demo",
    ctaHref: "#demo",
  },
  {
    ...
    highlight: true,
    features: [
      { label: "Native Mac app (.dmg)", included: true },
      { label: "Menu bar — runs globally", included: true },
      { label: "System-wide triggers", included: true },
      { label: "Global overlay reactions", included: true },
      { label: "All built-in sounds", included: true },
      { label: "All presets & triggers", included: true },
